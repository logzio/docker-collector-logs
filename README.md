...
| **DISABLE_DEFAULT_DROP_EVENTS** | **Default**: `false`. <br> By default, logs from this container are dropped using a `drop_event` processor. Set this to true to disable the processor and allow logs from this container to be shipped. <br/>                                                                                                                                                                                                     |
...
- 0.5.1:
  ...
  - Add option to disable the default `drop_event` processor for this container logs, with `DISABLE_DEFAULT_DROP_EVENTS`.
- 0.5.0:
